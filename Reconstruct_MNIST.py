...
def run_all_reconstructions():
    ...
    for NUM_MODES, DCT_FINAL_SIDE in zip(NUM_MODES_LIST, DCT_FINAL_SIDES):
        ...
        for i in range(all_data.shape[0]):
            ...
            # Use average norm for all samples
            drift_recon = reconstruct_from_drift(x_drift[i], modes, avg_norm=avg_norm)
...
if __name__ == "__main__":
    ...
    color_drift = "#08fb35"  # DRIFT green
    color_pca = "#0828f8"    # PCA blue
    color_dct = "#fb0404"    # DCT red
    ...
    plt.tight_layout()
    plt.savefig("mnist_recon_erro_avg_norm.png", dpi=1000)
    plt.show()
